...
class _DetayState extends State<Detay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(    //üst üste eklenmek istenen child yapılarını oluşturmak istiyorsan bunu kullanabilirsin
        children: <Widget>[
          Hero(
            tag: widget.imgPath,
            child: Container(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                      const EdgeInsets.only(left: 15, top: 10, bottom: 2,right: 15),
                      child: Row(
